    ...
    <script type="module" crossorigin="anonymous">
        ...
        document.getElementById('novnc_iframe').addEventListener('fullscreenchange', (event) => {
		  ...
		  if (document.fullscreenElement) {
		    ...
		    fullScreenButton.innerText = "Otwórz pełen ekran";
...
?>
	...
	<span style="display: block; text-align: center;" ><button style="font-size: 100%; margin-right: 10px;" id="send_space_button">Play/Pause</button><button style="font-size: 100%; margin-right: 10px;" id="send_prev_button">-10s./Prev. slide</button><button  style="font-size: 100%; margin-right: 10px;" id="send_next_button">+10s./Next slide</button><button style="font-size: 100%;" id="full_screen_button">Full screen</button></span>
    <div id="screen">
